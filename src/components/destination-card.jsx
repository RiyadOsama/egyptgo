  ...
  return (
    <>
      {destinations.map((destination) => (
        <div className="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition bg-card" key={destination._id}>
          <Image
          ...
          {show && (
            <div className="flex w-full justify-between">
              ...
              <button
                type="submit"
                onClick={() => deleteDestinationHandler(destination._id)}
                className="cursor-pointer px-2 py-1 transition duration-300 rounded-md text-card-foreground hover:opacity-90 mx-4 mb-4 border flex items-center w-[100px] justify-center"
              >
