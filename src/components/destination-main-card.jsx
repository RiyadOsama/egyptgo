const img = "imgs/destinations/aswan-nile-sunset-egypt.jpg";
    ...
    <div className="bg-card rounded-lg overflow-hidden shadow-md hover:shadow-lg transition cursor-pointer group h-full">
      ...
      <div className="p-6 bg-white">
        ...
        <p className="text-muted-(foreground) mb-4">
          Experience the beauty of the Nile with golden sunsets and ancient
          temples.
        </p>
        <div className="flex justify-between items-center">
          ...
          <span className="text-primary font-bold text-lg text-red-500">
            From $599
          </span>
        </div>
      </div>
