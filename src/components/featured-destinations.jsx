  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex justify-center items-center">
            <button className="bg-orange-600 mt-8 text-lg text-white px-4 py-2 rounded-lg hover:bg-orange-700 transition duration-300 cursor-pointer">View All Destinations</button>
        </div>
    </section>
